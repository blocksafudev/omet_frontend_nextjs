...
import RowMembership from "@/components/RowMembership";
...
export default function Index() {
  ...
  return (
    <>
      ...
      <div className="bg-white space-y-6 px-3 py-12 md:py-24 lg:py-16 md:px-12 lg:px-20">
        <div className="text-center font-semibold">
          <h1 className="text-5xl text-center">
            <span className="text-blackn-1000 tracking-wide">Membership </span>
            <span className="text-blackn-800">/ Month</span>
          </h1>
          <p className="pt-6 text-xl text-blackn-800 font-normal w-full px-8 md:w-full">
            Choose a plan that works best for you
          </p>
        </div>
        {isPending && <Spinner />}
        <div className="py-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-4">
          {memberships?.data?.map((membership) => {
            return (
              <RowMembership key={membership.id} membership={membership} />
            );
          })}
        </div>
      </div>
