...
const MyError = ({ statusCode, hasGetInitialPropsRun, err }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-screen">
      ...
      >
        <path
          id="b0cf38c7-358d-48dc-a444-e9782686dfa5-93"
          data-name="Path 438"
        ...
        ></path>
        <path
          id="acbbaa8b-0bc2-4bc9-96d7-93dd88f90f19-94"
          data-name="Path 439"
        ...
        ></path>
        <path
          id="bed63620-84ae-4c66-a7c8-0d9b30f8c1e7-95"
          data-name="Path 442"
        ...
        ></path>
        <path
          id="fc4eb8ca-daad-4589-b224-2c71eec1c546-96"
          data-name="Path 443"
        ...
        ></path>
        <path
          id="ec83fa9a-7bb4-4b90-a90b-e1cec4444963-97"
          data-name="Path 442"
        ...
        ></path>
        <path
          id="e32935a9-e392-46b4-9a67-68c65f1cc9fa-98"
          data-name="Path 443"
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="flex flex-col items-center justify-center">
          <Link
            className="flex items-center rounded-full px-6 py-3 mt-12 space-x-2 text-white transition duration-150 bg-black hover:bg-blackn-700"
            href="/"
          >
